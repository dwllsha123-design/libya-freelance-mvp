...
const HOME_CONTENT = {
  ar: {
    ...
    features: [
      { title: 'وسيط تقني شفاف', body: 'ليبي فريلانس منصة إعلانية ووسيط تقني لربط العملاء بالمستقلين — الاتفاق والدفع مباشرة بين الطرفين دون احتفاظ المنصة بأموال المشروع.', icon: '🤝' },
      ...
      { title: 'باقات للمستقلين', body: 'فترة تجريبية ثم باقات Starter وPro وPremium بحدود عروض واضحة — والدفع الإلكتروني للمنصة للاشتراكات والنقاط فقط.', icon: '📦' },
    ],
    steps: {
    ...
    faq: [
      { q: 'كيف يعمل نظام نقاطي؟', a: 'نقاطي مخصصة للمستقلين: تكسبها بالنشاط وتُستخدم لتقديم العروض. يمكنك أيضاً شراء نقاط عبر دفع المنصة. راجع صفحة النقاط من الحساب.' },
      { q: 'هل الانضمام مجاني؟', a: 'نعم. التسجيل والتصفح مجانيان لمدة تجريبية للمستقلين. الميزانيات والعروض بالدينار الليبي.' },
      { q: 'هل يوجد نظام حماية للمدفوعات؟', a: 'ليبي فريلانس منصة إعلانية ووسيط تقني لربط العملاء بالمستقلين. المنصة لا تستلم قيمة المشاريع ولا تحتفظ بأموال الأطراف ولا تضمن تنفيذ أو سداد قيمة المشروع. يتم الاتفاق والدفع مباشرة بين العميل والمستقل.' },
      { q: 'هل المدفوعات الإلكترونية مفعّلة الآن؟', a: 'الدفع الإلكتروني داخل ليبي فريلانس مخصص فقط للاشتراكات وشراء النقاط والخدمات الرقمية التي تقدمها المنصة.' },
  ...
  en: {
    ...
    features: [
      { title: 'Transparent technical intermediary', body: 'Libyan Freelance is an advertising platform and technical intermediary — agreement and payment happen directly between parties; the platform does not hold project funds.', icon: '🤝' },
      ...
      { title: 'Freelancer plans', body: 'A free trial, then Starter, Pro, and Premium with clear proposal quotas — platform payments cover subscriptions and points only.', icon: '📦' },
    ],
    steps: {
    ...
    faq: [
      { q: 'How does Nuqati work?', a: 'Nuqati is for freelancers: earn points through activity and use them to submit proposals. You can also buy points via platform payment. See your points page under Account.' },
      ...
      { q: 'Are electronic payments live now?', a: 'Electronic payments inside Libyan Freelance are only for subscriptions, points purchases, and digital services offered by the platform.' },
