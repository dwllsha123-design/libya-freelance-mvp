...
const HOME_CONTENT = {
  ar: {
    ...
    faq: [
      ...
      { q: 'هل يمكنني العمل كعميل ومستقل؟', a: 'حالياً كل حساب له دور واحد (عميل أو مستقل). يمكنك إنشاء حسابين ببريدين مختلفين إن احتجت الأمرين.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'Can I work as both client and freelancer?', a: 'Currently each account has one role (client or freelancer). You can create two accounts with different emails if you need both.' },
